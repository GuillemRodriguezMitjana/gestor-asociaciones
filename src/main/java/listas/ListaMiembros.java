...
/**
 * Clase que representa una lista de miembros (profesores y alumnos).
 * Permite agregar, buscar, y gestionar miembros, además de guardar y leer datos desde un archivo.
 */
public class ListaMiembros {
    ...
    /**
     * Devuelve una representación en forma de cadena de todos los alias de los miembros en la lista.
